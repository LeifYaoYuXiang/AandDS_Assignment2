...
public class AdjacencyMatrixTest {
	...
	public static void main( String[] args ) throws Exception {
	      ...
	      //test removing edges
	      g.removeEdge(lgapvd);
	      System.out.println( "edge lgapvd removed" );
	      if ( g.areAdjacent( lga,  pvd ) )
	          System.out.println( "LGA and PVD adjacent: correct" );
	       else
	          System.out.println( "LGA and PVD adjacent: incorrect" );
	      g.removeVertex(hnl);
	      System.out.println( "vertex hnl removed" );
	      g.removeVertex(dfw);
	      System.out.println( "vertex dfw removed" );
	      hnl = g.insertVertex( "HNL" );
	      // sample test for areAdjacent
	      if ( g.areAdjacent( sfo,  ord ) )
	         System.out.println( "SFO and ORD adjacent: correct" );
	      else
